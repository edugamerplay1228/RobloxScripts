...
local function KQLC_fake_script() -- Frame_2.VerifyScript 
	...
	function LoadScript()
		...
		Frame.Parent = Main
		Frame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		Frame.Position = UDim2.new(-0.0153921917, 0, -0.0253580995, 0)
		Frame.Size = UDim2.new(0, 517, 0, 57)
		Frame.Style = Enum.FrameStyle.RobloxRound
		...
		TextLabel.BorderSizePixel = 0
		TextLabel.Position = UDim2.new(-0.0237688832, 0, -0.154201031, 0)
		TextLabel.Size = UDim2.new(0, 523, 0, 55)
		TextLabel.ZIndex = 3
		TextLabel.Font = Enum.Font.Oswald
		TextLabel.Text = "[BETA] Shindo Life GUI"
		...
		TextLabel_2.Parent = KG1
		TextLabel_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		TextLabel_2.BackgroundTransparency = 1.000
		TextLabel_2.BorderColor3 = Color3.fromRGB(27, 42, 53)
		TextLabel_2.BorderSizePixel = 0
		TextLabel_2.Position = UDim2.new(-0.273768932, 0, 0.0765678212, 0)
		TextLabel_2.Size = UDim2.new(0, 54, 0, 33)
		TextLabel_2.ZIndex = 3
		TextLabel_2.Font = Enum.Font.Oswald
		TextLabel_2.Text = "KG1:"
		...
		Frame_2.Parent = KG1
		Frame_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		Frame_2.Position = UDim2.new(0, 0, 0.0765678212, 0)
		Frame_2.Size = UDim2.new(0, 199, 0, 32)
		Frame_2.Style = Enum.FrameStyle.RobloxRound
		...
		Frame_3.Parent = KG2
		Frame_3.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		Frame_3.Position = UDim2.new(0, 0, 0.0765678212, 0)
		Frame_3.Size = UDim2.new(0, 199, 0, 32)
		Frame_3.Style = Enum.FrameStyle.RobloxRound
		...
		TextLabel_4.Position = UDim2.new(-0.0628101304, 0, 0.924442291, 0)
		TextLabel_4.Size = UDim2.new(0, 239, 0, 31)
		TextLabel_4.ZIndex = 3
		TextLabel_4.Font = Enum.Font.Oswald
		TextLabel_4.Text = "Made by; EduGamerPlay1228"
		...
		local function WQQSX_fake_script() -- Main.Manager 
			...
			while wait() do
				...
				local text1 = KG1.Text
				game.Players.LocalPlayer.statz.main.kg1.Value = text1
			end
		end
		coroutine.wrap(WQQSX_fake_script)()
...
coroutine.wrap(KQLC_fake_script)()
